...
//require '/Applications/MAMP/htdocs/wordpress/wp-content/plugins/wimtvpro-wordpress-master/kint/Kint.class.php';
include_once 'kint/Kint.class.php';

function chiamaKint()
	{
//include	('/Applications/MAMP/htdocs/wordpress/wp-load.php');
//include("../../../../wp-load.php");
