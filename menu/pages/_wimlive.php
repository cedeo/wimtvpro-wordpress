...
//  "streamPath" => "nschannel1"
//    );
//    $response = apiCreateLiveChannel($params);
//    

//    $response = apiReadLiveChannel("fc2b95cc-5afe-4e4c-8dba-7aa8f2432c7e");
//    $eventDate = array(
//    "date" => "29/10/2016",
//    "time" => "14:00:00"
//    );
...
//    $response = apiCreateLiveEvent("fc2b95cc-5afe-4e4c-8dba-7aa8f2432c7e",$params);
...
//   "pricePerView" => "2,6"
//    );
//    $response = apiUpdateLiveEvent("f9e725b4-ce8b-4fef-9d1a-d734641e986c",$params);
//    
//    $response = apiPlayLiveEvent("f9e725b4-ce8b-4fef-9d1a-d734641e986c");
...
$enabledLive = $dati["features"]["vodPublic"];
$passwordLive = $dati["features"]["livePassword"];
//    if (strtoupper($enabledLive) != "TRUE") {
        if ($enabledLive != true && (!isset($passwordLive) || strlen($passwordLive) == 0)) { 
